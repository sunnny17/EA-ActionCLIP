...
class Adapter(nn.Module):
    def __init__(self, dim, adapter_dim=64, init_scale=1e-3):
        super().__init__()
    ...
    def forward(self, x):
        return self.scale * self.up(self.activation(self.down(x)))
...
class ResidualAttentionBlock(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None, dropout = 0.,
                 use_adapter=False, adapter_layers=None, layer_id=None, adapter_dim=64):
        super().__init__()
        ...
        self.adapter = None
        if use_adapter and (layer_id in adapter_layers):
...
class Transformer(nn.Module):
    def __init__(self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = None,
                 dropout=None, use_adapter=False, adapter_layers=None, adapter_dim=64):
        super().__init__()
        ...
        self.resblocks = nn.Sequential(*[
            ResidualAttentionBlock(
                width, heads, attn_mask, dropout=dropout[i],
                use_adapter=use_adapter, adapter_layers=adapter_layers,
                layer_id=i, adapter_dim=adapter_dim
            )
...
class VisualTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, output_dim: int, dropout=None, joint=False, emb_dropout=0., use_adapter=False, adapter_layers=None, adapter_dim=64):
        super().__init__()
        ...
        ## Attention Blocks
        self.transformer = Transformer(width, layers, heads, dropout=dropout, use_adapter=use_adapter, adapter_layers=adapter_layers or [], adapter_dim=adapter_dim)
...
class CLIP(nn.Module):
    def __init__(self,
                 ...
                 use_text_adapter=False, text_adapter_layers=None, text_adapter_dim=64,
                 use_visual_adapter=False, visual_adapter_layers=None, visual_adapter_dim=64
                 ):
        super().__init__()
        ...
        self.visual = VisualTransformer(
            ...
            use_adapter=use_visual_adapter,
            adapter_layers=visual_adapter_layers or [],
            adapter_dim=visual_adapter_dim
        )
        if tsm:
            print('=========using TSM==========')
        ...
        self.transformer = Transformer(
            ...
            dropout=dpr,
            use_adapter=use_text_adapter,
            adapter_layers=text_adapter_layers or [],
...
def build_model(state_dict: dict, tsm=False,T=8,dropout=0., joint=False,emb_dropout=0.,pretrain=True, use_text_adapter=False, text_adapter_layers=None, text_adapter_dim=64, use_visual_adapter=False, visual_adapter_layers=None, visual_adapter_dim=64):
    ...
    model = CLIP(
        ...
        text_adapter_layers=text_adapter_layers or [],
        text_adapter_dim=text_adapter_dim,
        use_visual_adapter=use_visual_adapter,
        visual_adapter_layers=visual_adapter_layers or [],
